  ...
  return (
    <section className="bg-primary-foreground py-12">
      <Container>
        ...
        {/* Layout */}
        <div className="grid lg:grid-cols-7 gap-8 items-stretch">

          {/* Image Column */}
          <div className="lg:col-span-2 bg-white rounded-sm overflow-hidden flex items-center justify-center">
          ...
          <div className="lg:col-span-5 grid sm:grid-cols-2 gap-5">
            ...
            {testimonials.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-lg shadow-md p-4 relative h-full"
              >

...
const AboutQualitySection = () => {
        ...
        <div className="relative hidden lg:block min-h-[980px]">
          ...
          <div className="max-w-full pt-10 space-y-3 z-20 relative">
            ...
            <p className="font-poppins text-[16px] font-medium text-accent-foreground leading-relaxed max-w-full">
              ...
              safe, and refreshing drinking water. Our water goes through
              advanced multi-stage purification, including RO and UV treatment,
              to remove impurities while maintaining essential minerals.
              Every bottle is tested to ensure the highest quality and hygiene
              standards.
            </p>
          ...
          <img
            ...
            alt="Model"
            className="absolute left-[20%] top-[-250px] w-[600px] xl:w-[820px] 2xl:w-[890px] z-20"
          />

          {/* TEAL PANEL */}
          <div className="absolute right-[-100px] top-[200px] w-[364px] h-[750px] bg-primary rounded-tl-[54px] rounded-bl-[54px] p-8 text-white z-10">

            <div className="space-y-10 mt-4">

              {[
                { title: "Naturally Alkaline", img: "/images/alkaline.png" },
                { title: "Minerals and Electrolytes", img: "/images/minerals.png" },
                { title: "Bottled at the Source", img: "/images/source.png" },
                { title: "Infinitely Recyclable", img: "/images/recycle.png" },
              ].map((item, i) => (
          ...
          {/* BENEFITS CARD */}
       <div className="absolute bottom-25 w-[450px] bg-white border border-gray-300 rounded-[49px] p-10 shadow-sm z-10">
  ...
  <div className="space-y-8">
    ...
    {[
      {
        title: "Assured Purity in Every Drop",
        icon: "/images/AboutQuality.svg",

      },
      {
        title: "Balanced Minerals, Better Health",
        icon: "/images/AboutBenefit.png",

      },
      {
        title: "Advanced Purification Technology",
        icon: "/images/AboutDrinking.png",
      ...
      <div key={i} className="flex gap-6 items-start">
        ...
        {/* Icon Box */}
        <div className="w-[55px] h-[65px] bg-gray-100 rounded-[6px] flex items-center justify-center">

          <img
            src={item.icon}
            alt={item.title}
            className="w-[42px] h-[3=42px] object-contain"
          />
